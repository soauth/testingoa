...
<div id="main">
	...
	<table width="100%">
		<?php
					$result=mysql_query("select * from audios where type='o' ORDER BY song ASC");
				...
				if(mysql_num_rows($result)==0)
					...
					else
					{
						echo "<table id=\"song\">";
						echo	"<tr id=\"m1\">";
						echo	"<td> <b>Select</b></td><td></td><td width=\"250\"><font color=\"Green\" size=\"6px\"><b>Song </b></font></td><td></td><td></td><td width=\"500\"><font color=\"Green\" size=\"6px\"><b>Artist</b></font></td>";
						echo "</tr>";
